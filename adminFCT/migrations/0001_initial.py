# Generated by Django 4.1.2 on 2023-01-25 13:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kas', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recibido', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminFCT.empleado')),
            ],
        ),
        migrations.AddField(
            model_name='funcion',
            name='perfil',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminFCT.perfil'),
        ),
        migrations.AddField(
            model_name='empresa',
            name='forma',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminFCT.forma'),
        ),
        migrations.AddField(
            model_name='empresa',
            name='ramo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminFCT.ramo'),
        ),
        migrations.AddField(
            model_name='empresa',
            name='tam',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminFCT.tamano'),
        ),
        migrations.AddField(
            model_name='contacto',
            name='empresa',
