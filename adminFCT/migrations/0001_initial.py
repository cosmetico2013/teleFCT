# Generated by Django 4.1.2 on 2023-03-09 01:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curri', models.URLField(blank=True, null=True)),
                ('proy', models.URLField(blank=True, null=True)),
                ('fnac', models.DateField()),
                ('sex', models.CharField(max_length=1)),
                ('dis', models.DecimalField(decimal_places=0, default=0, max_digits=3)),
                ('cpAlu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminFCT.distritos')),
            ],
        ),
        migrations.CreateModel(
            name='Contacto',
            fields=[
                ...
                ('movCon', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fmen', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fofe', models.DateField(blank=True, null=True)),
                ...
                ('empresa', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='adminFCT.empresa')),
                ('especifaciones', models.ManyToManyField(to='adminFCT.requisito')),
                ('toolboxes', models.ManyToManyField(to='adminFCT.tool')),
                ('contacto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='adminFCT.contacto')),
            ],
        ),
        migrations.CreateModel(
            name='Contrato',
